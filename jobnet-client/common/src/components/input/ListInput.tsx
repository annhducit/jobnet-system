  ...
  return (
    <div className="space-y-2">
      ...
      <ul
        data-id={id}
        className={clns(
          'flex flex-col gap-3 p-2.5 list-disc list-inside border rounded-lg border-main-lower',
          {
            'ring-2 ring-main border-transparent': listInput.isFocus,
          }
        )}
      >
        {listItemElms}
        <div className="flex gap-2">
          ...
          />
          <FaCirclePlus
            className="w-5 h-5 cursor-pointer text-second hover:text-main"
...
function ListInputItem({ name, value, onDeleteClick }: ListInputItemProps) {
  return (
    <div className="flex items-center justify-between">
      ...
      <FaXmark
        className="w-4 h-4 cursor-pointer text-second hover:text-main"
