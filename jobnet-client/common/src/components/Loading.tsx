...
export default function Loading({ show, onClose }: LoadingProps): JSX.Element {
  return (
...
export function LoadingGenerateJD({ show }: { show: boolean }) {
  return (
    <>
      {show && (
        <div className="flex flex-col items-center gap-2">
          <svg
            ...
            fill="currentColor"
            className="w-12 h-12 animate-spin text-main"
            viewBox="0 0 16 16"
          >
