...
class LocationService {
  ...
  async getLocations() {
    const apiBaseUrl = `${import.meta.env.VITE_API_BASE_URL}/api/location`
    const res = await axios.get(`${apiBaseUrl}/provinces`)
    checkResponseNotOk(res)
    return getResponseData<APILocationType[]>(res)
  }
}
