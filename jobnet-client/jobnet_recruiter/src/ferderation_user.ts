declare module "User/RC/Campaigns"
declare module "User/RC/Appliciant"
declare module "User/Profile"
declare module "User/RC/AuthHeaderRC"
...
declare module "User/JobSeeker/services"{
    ...
    // export function updateJobSeekerPersonalInfo(id: string, req: object): Promise<JobSeekerType>
    // export function updateJobSeekerProfessionInfo(id: string, req: object): Promise<JobSeekerType>
    // export function updateJobSeekerInfo(url: string, req: object): Promise<JobSeekerType>
    ...
    // export function uploadJobSeekerProfileImage(id: string, formData: FormData): Promise<JobSeekerType>
    // export function updateJobSeekerBusinessFollowed(id: string, req: object): Promise<JobSeekerType>
}
...
declare module "User/Registration"{
    ...
    // export function registerRecruiterWithNewBusiness(req: object): Promise<UserType>
    // export function registerRecruiterWithSelectedBusiness(req: object): Promise<UserType>
    // export function verifyUser(req: object): Promise<void>
}
declare module "User/Recruiter/services"{
    export function getRecruiterById(id: string): Promise<Recruiter>
